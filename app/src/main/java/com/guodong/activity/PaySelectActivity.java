...
public class PaySelectActivity extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zhifubaoRb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    com.guodong.util.PayResult payResult = new com.guodong.util.PayResult((String) msg.obj);
    ...
    public String sign(String content) {
        return com.guodong.util.SignUtils.sign(content, RSA_PRIVATE);
    }
